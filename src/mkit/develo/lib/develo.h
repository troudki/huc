...
int   dv_set_ram(int addr, unsigned char *data, int len);
int   dv_get_ram(unsigned char *data, int addr, int len);
int   dv_set_vram(int addr, unsigned char *data, int len);
int   dv_get_vram(unsigned char *data, int addr, int len);
int   dv_set_color(int addr, unsigned char *data, int len);
int   dv_get_color(unsigned char *data, int addr, int len);
int   dv_exec(int addr, int slave);
int   dv_read_cd(unsigned char *data, int sect);
